//
//  AccountsOrderViewController.m
//  Owl_iOS_Pro
//
//  Created by Aang on 16/9/21.
//  Copyright © 2016年 Aang. All rights reserved.
//

#import "AccountsOrderViewController.h"
#import "PlaceAnOrderCell.h"
@interface AccountsOrderViewController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, retain)UITableView *tableV;

@end

@implementation AccountsOrderViewController
