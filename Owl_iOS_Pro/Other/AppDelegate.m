...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSString *version = [NSBundle mainBundle].infoDictionary[bundleVersionKey];
    NSString *exVersion = [[NSUserDefaults standardUserDefaults] objectForKey:bundleVersionKey];
    if ([version isEqualToString:exVersion]) {
        //进入主界面
        ...
        //进入引导页
        [[NSUserDefaults standardUserDefaults] setObject:version forKey:bundleVersionKey];
